...
public class UserDao implements UserDaoInterface {
    ...
    public FirebaseAuth getAuthenticationInstance() {
        ...
        try { firebaseAuthInstance = FirebaseAuth.getInstance(); }
        catch (Exception ex) {
    ...
    public DocumentSnapshot getUserDocumentByUId(String uid, String email, String databaseCollection) {
        ...
        try {
            ...
            if (documents.size() == 1) { documentSnapshot = documents.get(0); }
            else {
    ...
    public UserRecord getUId(String uId, FirebaseAuth firebaseAuthInstance) {
        ...
        try { userRecord = firebaseAuthInstance.getUser(uId); }
        catch (Exception ex) {
    ...
    public boolean removeProfileField(String uId, String username, String key, String databaseCollection) {
        ...
        try {
            ...
            if (documentData.containsKey(key)) { documentData.put(key, FieldValue.delete()); }
            else { return result;  }
    ...
    public List<DocumentSnapshot> listUsers(String databaseCollection) {
        ...
        try {
            ...
            for (DocumentSnapshot document: documents) { listDocumentSnapshot.add(document); }
        }
        catch (Exception ex) {
